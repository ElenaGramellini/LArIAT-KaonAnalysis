...
// Tue Oct 25 10:30:57 2016 by ROOT version 6.06/04
// from TTree anatree/analysis tree
// found on file: AtWC2TPCFilter.root
//////////////////////////////////////////////////////////

#ifndef BasicChecks_h
#define BasicChecks_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[193];   //[nclus]
   Double_t        clusterttick[193];   //[nclus]
   Double_t        cluendwire[193];   //[nclus]
   Double_t        cluendtick[193];   //[nclus]
   Int_t           cluplane[193];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[5155];   //[nhits]
   Int_t           hit_wire[5155];   //[nhits]
   Int_t           hit_channel[5155];   //[nhits]
   Double_t        hit_peakT[5155];   //[nhits]
   Double_t        hit_charge[5155];   //[nhits]
   Double_t        hit_ph[5155];   //[nhits]
   Double_t        hit_tstart[5155];   //[nhits]
   Double_t        hit_tend[5155];   //[nhits]
   Int_t           hit_trkid[5155];   //[nhits]
   Int_t           hit_trkkey[5155];   //[nhits]
   Int_t           hit_clukey[5155];   //[nhits]
   Int_t           hit_pk[5155];   //[nhits]
   Int_t           hit_t[5155];   //[nhits]
   Int_t           hit_ch[5155];   //[nhits]
   Int_t           hit_fwhh[5155];   //[nhits]
   Double_t        hit_rms[5155];   //[nhits]
   Double_t        hit_nelec[5155];   //[nhits]
   Double_t        hit_energy[5155];   //[nhits]
   Float_t         hit_dQds[5155];   //[nhits]
   Float_t         hit_dEds[5155];   //[nhits]
   Float_t         hit_ds[5155];   //[nhits]
   Float_t         hit_resrange[5155];   //[nhits]
   Float_t         hit_x[5155];   //[nhits]
   Float_t         hit_y[5155];   //[nhits]
   Float_t         hit_z[5155];   //[nhits]
   Int_t           nwctrks;
...
#ifdef BasicChecks_cxx
BasicChecks::BasicChecks(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/app/users/elenag/v06_13_00/gitProject/gridSub/anaTree_histo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/app/users/elenag/v06_13_00/gitProject/gridSub/anaTree_histo.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/app/users/elenag/v06_13_00/gitProject/gridSub/anaTree_histo.root:/anatree");
...
Int_t BasicChecks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BasicChecks::LoadTree(Long64_t entry)
{
...
void BasicChecks::Init(TTree *tree)
{
...
void BasicChecks::Show(Long64_t entry)
{
...
Int_t BasicChecks::Cut(Long64_t entry)
{
